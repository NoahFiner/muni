...
const CloseIcon = () => (
  ...
  <path d="M25.4522 2.75804C25.1838 2.97176 24.824 3.42262 23.6428 4.66695C21.2002 7.24008 18.9679 8.86079 18.373 9.50048C17.2197 10.7406 15.8335 12.0737 14.1509 13.8583C13.3129 14.7472 12.6701 15.479 9.98712 18.5549C7.76453 20.7131 6.3379 22.4035 5.83691 23.0232C5.61783 23.3089 5.47013 23.536 5.11461 23.932" stroke="black" strokeWidth="3" strokeLinecap="round"/>
  <path d="M3.08398 2.96973C3.14226 3.05571 3.20054 3.14169 4.00904 3.93765C4.81754 4.73361 6.3745 6.23693 8.36467 7.94276C10.3548 9.64859 12.731 11.5114 14.0494 12.5639C15.3677 13.6164 15.5562 13.8022 15.8632 14.0691C16.579 14.6915 17.3996 15.403 18.0098 15.996C18.3108 16.2884 18.9796 16.9885 19.8843 18.0156C20.4165 18.6198 20.6765 18.8751 20.9612 19.2392C21.4188 19.8245 21.7872 20.1234 22.0147 20.4016C22.3202 20.7754 22.7527 21.1551 23.0992 21.4523C23.3846 21.6972 23.6396 21.9602 24.3278 22.5296C25.0759 23.1664 25.3852 23.3609 25.6761 23.5948C25.7539 23.6441 25.8289 23.681 25.9062 23.719" stroke="black" strokeWidth="3" strokeLinecap="round"/>
  </svg>
)

const Modal = ({modalOpenUrl, closeModal}: {modalOpenUrl: string, closeModal: () => void}) => {
  return (
    <div className="modal-outer">
      <div className="modal-inner">
        ...
        <p style={{width: "calc(100% - 40px - 3rem)"}}>If you're on desktop, download your results <strong className="fake-link" onClick={() => download(modalOpenUrl, "transit.png")}>by clicking here</strong>.</p>
        <p>If you're on mobile, hold down on your results image until you have an option to save it to your camera roll.</p>
...
const Results: React.FC = () => {
  ...
  return (
    <div className="results-outer">
      {
        modalOpenUrl && <Modal modalOpenUrl={modalOpenUrl} closeModal={() => {setModalOpenUrl("")}} />
      }
      <div id="results-save">
